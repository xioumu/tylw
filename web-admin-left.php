<?php judgeUser(array('web')); ?>
<html>
<body>
<!-- left menu starts -->
<div class = "span2 main-menu-span">
    <div class = "well row-fluid  sidebar-nav">
        <ul class = "nav nav-tabs nav-stacked main-menu">
            <li class = "nav-header hidden-tablet">菜单</li>
            <li><a class = "ajax-link" href = "web-admin-student-manage.php"><span class = "hidden-tablet">管理学生账号</span></a>
            </li>
            <li><a class = "ajax-link" href = "web-admin-OnTeacher-manage.php"><span
            ...
            <li><a class = "ajax-link" href = "web-admin-set-repeatRate.php"><span
