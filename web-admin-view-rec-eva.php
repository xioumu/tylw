...
<div class = "container-fluid">
    <div class = "row-fluid">
        ...
        <div id = "content" class = "span10">
            ...
            <?php
            if (!isset($_GET['id']) && !isset($_GET['judgeInfo'])) {
                errorUser();
            }
            $eid = $_GET['id'];
                        ...
                        <form class = "form-horizontal">
                            <table class = "table table-bordered">
                                <tr>
                                    ...
                                    <td class = "boxContent " colspan = "2"><?php echo $evaInfo['paperNum']; ?></td>
                                    <th class = "boxContent title" colspan = "1">论文题目</th>
                                    <td class = "boxContent" colspan = "2"><?php echo $evaInfo['paperName']; ?></td>
                                </tr>
                                <tr>
